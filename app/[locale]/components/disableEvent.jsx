...
export default function DisableEvent() {
     const t = useTranslations("eventDisplay");
     const th = useTranslations("disableevent")
    return (
      <div className="flex items-center justify-center h-screen bg-gray-900 text-white">
        ...
        <div className="text-center p-8 bg-gray-800 rounded-2xl shadow-lg">
          <h1 className="text-4xl font-bold mb-4">{th("disableevent")}</h1>
          <p className="text-lg text-gray-400">{th("disableeventadmin")}</p>
        </div>
      </div>
    );
  }
